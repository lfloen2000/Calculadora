...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_numero_uno = findViewById(R.id.numero_1);
        edit_numero_dos = findViewById(R.id.numero_2);
    }
    ...
    private double resta (int a, int b) {
        return a-b;
    }
    ...
    private double multiplicacion (int a, int b) {
        return a*b;
    }
